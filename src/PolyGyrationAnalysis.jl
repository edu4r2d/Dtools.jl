#import Pkg; Pkg.activate("/home/m3g/Documentos/polyisobutileno/Projeto_programa")
...
#Rg_list = PolyGyrationAnalysis.run_analysis("box_0.pdb", "9.1_prod_reduced.dcd", 15000, "segname POLI")
#PolyGyrationAnalysis.save_radius_of_gyration(Rg_list, "radius_of_gyration.dat")
#PolyGyrationAnalysis.plot_radius_of_gyration(Rg_list)
